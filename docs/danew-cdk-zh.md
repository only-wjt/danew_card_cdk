...
- **兑换接口 Base**:`https://www.avanfinity.com/api/v1/cdk`(公开,无需登录,凭有效码兑换)
- **发码/管理**:网页「开发者 · 隐藏 GPT 直充」页,或 Open API `https://www.avanfinity.com/openapi/v1`
...
- **配置后端地址**:页面读取 `?api=<base>`、`localStorage.cdk_api_base` 或内置 `CONFIGURED_BASE`,指向 `https://www.avanfinity.com`。
